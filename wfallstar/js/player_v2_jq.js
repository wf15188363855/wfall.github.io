...
!function(a) {
            ...
            return "film.qq.com" == document.location.host && (i = !0),
            {
                    ...
                    if (tvp.$.browser.ie)
                        try {
                            f = "IE begin",
                                ...
                                "undefined" != typeof c.getVersion ? (d = c.GetVersionByClsid(e.config.OCX_CLSID),
                                    f = "get actObj.GetVersionByClsid:" + d) : f = "no function:actObj.GetVersionByClsid"
                        } catch (j) {
                        ...
                        if (tvp.$.isUndefined(l.namedItem) || (f = "plugs.namedItem",
                                k = l.namedItem("\u817e\u8baf\u89c6\u9891")),
                                !k) {
                        ...
                        if (k)
                            if (tvp.$.isUndefined(k.version)) {
                                ...
                                f = "plug.version:" + k.version,
                                    d = k.version;
                        else
                            f = "no plugs[i].filename:npQQLive.dll"
                    }
                ...
                getFlash: function() {
                    ...
                    if (tvp.$.browser.ie)
                        ...
                        tvp.$.isUndefined(j.plugins) || "object" != typeof j.plugins[e] || (a = "no IE begin",
                            c = j.plugins[e].description,
    ...
    e.log = tvp.log,
        ...
        e.version = function() {
            function a(a) {
                if (e.version.checkVerFormatValid(a))
                    return a;
                if (/\d+/i.test(a)) {
            ...
            return _version = {},
            {
                ...
                check: function(b) {
                    if (b = b || e.version.getSupportMinVersion(),
                            !e.version.checkVerFormatValid(b))
                        return !1;
                ...
                hasOldVersion: function() {
                    ...
                    return a ? (c = e.version.compare(a, e.config.OLD_MIN_VER) > 0 ? 1 : 0,
                        !!c) : !1
                },
                hasQQLivePlayer: function() {
                    ...
                    return a ? (b = e.version.compare(a, "0.0.0.0") > 0 ? 1 : 0,
                        !!b) : !1
                },
        ...
        e.event = {
            ...
            reportTCSSHot: function(a, b) {
                ...
                }) : (e.event.rptImg = new Image,
                    e.event.rptImg.src = "http://pinghot.qq.com/pingd?dm=v.qq.com.hot&url=/virtual/ocx.html&tt=" + escape(document.title) + "&hottag=OCX.SETUP." + a + "&hotx=9999&hoty=9999&rand=" + Math.round(1e5 * Math.random())),
