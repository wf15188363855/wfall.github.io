...
$(document).ready(function(){
    ...
    if(username){
        $("#SM_name").html(username);      /*将URL的name赋值给页面tittle*/
    }else {
        $("#SM_name").html("鲸落WFall");
    }
    /********页面右下角跳转链接赋值*********/
...
// 生成二维码
    ...
    function createQr(){
        ...
        var valText = "https://www.wfall.cn/wfall3Dbox/wfall3Dku/wfall_shengdanshu.html?ip="+ip+"&username="+valName;
