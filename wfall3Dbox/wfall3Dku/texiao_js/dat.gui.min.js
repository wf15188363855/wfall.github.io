        ...
        , function(e, t, n) {
            ...
            var s = n(12)
                ...
                function t(n, o, a) {
                    ...
                    function d() {
                        c["default"].unbind(window, "mousemove", u),
                            c["default"].unbind(window, "mouseup", d)
                    }
                    function f(e) {
                        c["default"].bind(window, "mousemove", u),
                    ...
                    var h = p
                        , m = void 0;
                    return p.__input = document.createElement("input"),
                        p.__input.setAttribute("type", "text"),
                        c["default"].bind(p.__input, "change", l),
                        c["default"].bind(p.__input, "blur", s),
                        c["default"].bind(p.__input, "mousedown", f),
                        c["default"].bind(p.__input, "keydown", function(e) {
                ...
                return a(t, e),
                    t.prototype.updateDisplay = function() {
                        return c["default"].isActive(this.__input) ? this : (this.__input.value = this.__truncationSuspended ? this.getValue() : l(this.getValue(), this.__precision),
                            e.prototype.updateDisplay.call(this))
                    }
                    ,
                    t
            ...
            var s = n(12)
                ...
                function t(n, o, a, s, u) {
                    ...
                    function f(e) {
                        ...
                        return h.setValue(l(e.clientX, t.left, t.left + n, h.__min, h.__max)),
                            !1
                    }
                    function _() {
            ...
            var u = n(7)
                ...
                function t(n, o) {
                    ...
                    function d() {
                        ...
                        e !== !1 ? (v.__color.__state = e,
                            v.setValue(v.__color.toOriginal())) : this.value = v.__color.toString()
                    }
                    function c() {
                    ...
                    y.__color = new p["default"](y.getValue()),
                        y.__temp = new p["default"](0);
                    var v = y;
                    y.domElement = document.createElement("div"),
                        f["default"].makeSelectable(y.domElement, !1),
                        y.__selector = document.createElement("div"),
                        y.__selector.className = "selector",
                        y.__saturation_field = document.createElement("div"),
                        y.__saturation_field.className = "saturation-field",
                        y.__field_knob = document.createElement("div"),
                        y.__field_knob.className = "field-knob",
                        y.__field_knob_border = "2px solid ",
                        y.__hue_knob = document.createElement("div"),
                        y.__hue_knob.className = "hue-knob",
                        y.__hue_field = document.createElement("div"),
                        y.__hue_field.className = "hue-field",
                        y.__input = document.createElement("input"),
                        y.__input.type = "text",
                        y.__input_textShadow = "0 1px 1px ",
                        f["default"].bind(y.__input, "keydown", function(e) {
                            13 === e.keyCode && d.call(this)
                        }),
                        f["default"].bind(y.__input, "blur", d),
                        f["default"].bind(y.__selector, "mousedown", function() {
                    ...
                    return g["default"].extend(y.__selector.style, {
                        ...
                        g["default"].extend(y.__hue_field.style, {
                            width: "15px",
                            height: "100px",
                            border: "1px solid #555",
                            cursor: "ns-resize",
                        ...
                        s(y.__hue_field),
                        g["default"].extend(y.__input.style, {
                            outline: "none",
                            textAlign: "center",
                            color: "#fff",
                            border: 0,
                        ...
                        f["default"].bind(y.__saturation_field, "mousedown", a),
                        f["default"].bind(y.__field_knob, "mousedown", a),
                        f["default"].bind(y.__hue_field, "mousedown", function(e) {
                            b(e),
                                f["default"].bind(window, "mousemove", b),
                                f["default"].bind(window, "mouseup", c)
                        }),
                        y.__saturation_field.appendChild(w),
                        y.__selector.appendChild(y.__field_knob),
                        y.__selector.appendChild(y.__saturation_field),
                        y.__selector.appendChild(y.__hue_field),
                        y.__hue_field.appendChild(y.__hue_knob),
                        y.domElement.appendChild(y.__input),
                        y.domElement.appendChild(y.__selector),
                        y.updateDisplay(),
                        y
                }
                return a(t, e),
        ...
        , function(e, t, n) {
            ...
            function a(e, t, n) {
                if (n.__li = t,
                    ...
                    var o = function(t) {
                        return G["default"].isNumber(n.__min) && G["default"].isNumber(n.__max) ? (n.remove(),
                            s(e, n.object, n.property, {
                                before: n.__li.nextElementSibling,
                                factoryArgs: [n.__min, n.__max, n.__step]
                            })) : t
                    };
                    n.min = G["default"].compose(o, n.min),
                        n.max = G["default"].compose(o, n.max)
                } else
                    n instanceof O["default"] ? (z["default"].bind(t, "click", function() {
                        ...
                        })) : n instanceof H["default"] && (z["default"].addClass(t, "color"),
                        n.updateDisplay = G["default"].compose(function(e) {
            ...
            function s(e, t, n, o) {
                ...
                return z["default"].addClass(c, oe.CLASS_CONTROLLER_ROW),
                    r instanceof H["default"] ? z["default"].addClass(c, "color") : z["default"].addClass(c, g(r.getValue())),
                    a(e, c, r),
            ...
            function _(e) {
                ...
                e.__resize_handle = document.createElement("div"),
                    G["default"].extend(e.__resize_handle.style, {
                        width: "6px",
                        marginLeft: "-3px",
                        height: "200px",
                        cursor: "ew-resize",
            ...
            var W = "dg"
                ...
                this.domElement = document.createElement("div"),
                    ...
                    z["default"].addClass(this.domElement, W),
                    this.__folders = {},
                    this.__controllers = [],
                ...
                G["default"].isUndefined(o.parent) && o.hideable && ne.push(this),
                ...
                o.autoPlace && (G["default"].isUndefined(o.parent) && ($ && (ee = document.createElement("div"),
                    z["default"].addClass(ee, W),
            ...
            oe.toggleHide = function() {
                ...
                G["default"].extend(oe.prototype, {
                    ...
                    onResize: G["default"].debounce(function() {
                        ...
                        if (e.scrollable) {
                            ...
                            G["default"].each(e.__ul.childNodes, function(t) {
                                ...
                                window.innerHeight - t - Q < n ? (z["default"].addClass(e.domElement, oe.CLASS_TOO_TALL),
                                    e.__ul.style.height = window.innerHeight - t - Q + "px") : (z["default"].removeClass(e.domElement, oe.CLASS_TOO_TALL),
                    ...
                    remember: function() {
                        if (G["default"].isUndefined(Z) && (Z = new F["default"],
                    ...
                    getSaveObject: function() {
                        ...
                        e.remembered || (e.remembered = {}),
                            ...
                            e.folders = {},
                            G["default"].each(this.__folders, function(t, n) {
                    ...
                    saveAs: function(e) {
                        this.load.remembered || (this.load.remembered = {},
                            this.load.remembered[J] = h(this, !0)),
