...
function pop(e, t, n) {
    isnowpop = !0, e = e || "../img/wf_logo.png";
    var i = $("#pop");
...
!function (e, t) {
    ...
    "use strict";
    var s = "fullpage-wrapper", a = "." + s, r = "fp-scrollable", l = "." + r, c = "fp-responsive", u = "fp-notransition", d = "fp-destroyed", f = "fp-enabled", h = "fp-viewing", p = "active", g = "." + p, m = "fp-completely", v = "." + m, y = ".section", C = "fp-section", k = "." + C, b = k + g, S = k + ":first", w = k + ":last", F = "fp-tableCell", L = "." + F, x = "fp-auto-height", T = "fp-normal-scroll", M = "fp-nav", D = "#" + M, $ = "fp-tooltip", I = "." + $, E = "fp-show-active", A = ".slide", B = "fp-slide", O = "." + B, j = O + g, P = "fp-slides", z = "." + P, H = "fp-slidesContainer", R = "." + H, Q = "fp-table", q = "fp-slidesNav", _ = "." + q, N = _ + " a", Y = "fp-controlArrow", W = "." + Y, U = "fp-prev", V = "." + U, X = Y + " " + U, G = W + V, K = "fp-next", J = "." + K, Z = Y + " " + K, et = W + J, tt = e(t), nt = e(n), it = {
        scrollbars: !0,
        mouseWheel: !0,
        hideScrollbars: !1,
        fadeScrollbars: !1,
    ...
    e.fn.fullpage = function (r) {
        ...
        function Et() {
            ...
            if (!r.autoScrolling || r.scrollBar) {
                var i = tt.scrollTop(), o = Ot(i), s = 0, a = i + tt.height() / 2, l = ui.height() - tt.height() === i, c = n.querySelectorAll(k);
                ...
                if (Bt(o) && (e(b).hasClass(m) || e(b).addClass(m).siblings().removeClass(m)), t = e(c).eq(s), !t.hasClass(p)) {
                    Oi = !0;
                    var f, h, g = e(b), v = g.index(k) + 1, y = $n(t), C = t.data("anchor"), S = t.index(k) + 1, w = t.find(j);
        ...
        function _t(n) {
            ...
            if (r.autoScrolling && !pi && !s) {
                n = n || t.event;
                var a = n.wheelDelta || -n.deltaY || -n.detail, l = i.max(-1, i.min(1, a)), c = "undefined" != typeof n.wheelDeltaX || "undefined" != typeof n.deltaX, u = i.abs(n.wheelDeltaX) < i.abs(n.wheelDelta) || i.abs(n.deltaX) < i.abs(n.deltaY) || !c;
        ...
        function an() {
            var e = t.location.hash.replace("#", "").split("/"), n = decodeURIComponent(e[0]), i = decodeURIComponent(e[1]);
            n && (r.animateAnchor ? zn(n, i) : ut(n, i))
        }

        function rn() {
            if (!Oi && !r.lockAnchors) {
                var e = t.location.hash.replace("#", "").split("/"), n = decodeURIComponent(e[0]), i = decodeURIComponent(e[1]), o = "undefined" == typeof fi, s = "undefined" == typeof fi && "undefined" == typeof i && !mi;
        ...
        function Fn() {
            var e = r.responsive || r.responsiveWidth, t = r.responsiveHeight, n = e && tt.outerWidth() < e, i = t && tt.height() < t;
        ...
        var fi, hi, pi, gi, mi = !1, vi = navigator.userAgent.match(/(iPhone|iPod|iPad|Android|playbook|silk|BlackBerry|BB10|Windows Phone|Tizen|Bada|webOS|IEMobile|Opera Mini)/), yi = "ontouchstart" in t || navigator.msMaxTouchPoints > 0 || navigator.maxTouchPoints, Ci = e(this), ki = tt.height(), bi = !1, Si = !0, wi = !0, Fi = [], Li = {};
    ...
    e.fn.hover3d = function (t) {
        ...
        return this.each(function () {
            ...
            function i(e) {
                var t = a.innerWidth(), i = a.innerHeight(), o = Math.round(e.pageX - a.offset().left), s = Math.round(e.pageY - a.offset().top), l = n.invert ? (t / 2 - o) / n.sensitivity : -(t / 2 - o) / n.sensitivity, c = n.invert ? -(i / 2 - s) / n.sensitivity : (i / 2 - s) / n.sensitivity, u = o - t / 2, d = s - i / 2, f = Math.atan2(d, u), h = 180 * f / Math.PI - 90;
                0 > h && (h += 360), a.css({
...
!function (e) {
    ...
    FlipClock.Face = FlipClock.Base.extend({
        ...
        createDivider: function (t, n, i) {
            ...
            var s = ['<span class="' + this.factory.classes.divider + " " + (n ? n : "").toLowerCase() + '">', '<span class="' + this.factory.classes.label + '">' + (t ? t : "") + "</span>", o, "</span>"], a = e(s.join(""));
...
$(window).on("resize orientationchange", adjustSize), adjustSize(), /iPhone|iPad|iPod|Android/i.test(navigator.userAgent) ? (tryPgvSendClick({hottag: "a20170301pre.support.mobile"}), ismobile = !0, $("body").addClass("mobile"), $(".loadingwrapper").hide(), setTimeout(function () {
    $(".loadingwrapper").show()
}, 1e3), document.title = "鲸落WFall") : tryPgvSendClick({hottag: "a20170301pre.support.notmobile"}), $("#fullpage .dot").prepend("<b></b>"), $("#pop .pop-close").on("click", function () {
